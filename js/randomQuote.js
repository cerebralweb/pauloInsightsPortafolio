...
document.getElementById ('shareTweet').href = "https://twitter.com/intent/tweet?text=" + slot1.replace('<strong itemprop="author" ><em><i style="font-size: 1rem; color: rgb(175, 174, 174);" ">','--').replace('</i></em></strong>','--') + "#quote @clpalacios_in";
